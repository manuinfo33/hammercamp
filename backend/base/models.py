...
class Tournament(models.Model):
    ...
    max_players_buena_fe = models.PositiveIntegerField(null=True, blank=True, default=25, verbose_name="Máximo de Jugadores Lista Buena Fe")
    pts_win = models.PositiveIntegerField(default=3, validators=[MinValueValidator(1), MaxValueValidator(5)], verbose_name="Puntos por Partido Ganado")
    pts_draw = models.PositiveIntegerField(default=1, validators=[MinValueValidator(0), MaxValueValidator(5)], verbose_name="Puntos por Partido Empatado")
    pts_loss = models.PositiveIntegerField(default=0, validators=[MinValueValidator(0), MaxValueValidator(5)], verbose_name="Puntos por Partido Perdido")
    yellow_cards_suspension = models.PositiveIntegerField(null=True, blank=True, default=None, verbose_name="Amarillas para Suspensión")
    description = models.TextField(blank=True, null=True, verbose_name="Descripción / Modalidad del Torneo")
    half_duration = models.PositiveIntegerField(default=35, validators=[MinValueValidator(1), MaxValueValidator(200)], verbose_name="Duración de cada Tiempo")
